...
public class Menu extends JFrame {
    ...
    public Menu() {
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Erro ao inicializar a interface gráfica: " + e.getMessage());
        }
    }
    ...
    private void adicionarComponentes() {
        try {
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Erro ao adicionar componentes: " + e.getMessage());
        }
    }
    ...
    private void adicionarBotoes(JPanel painel) {
        try {
            ...
            btnVincularEquipamentos
                    .addActionListener(e -> new VincularEquipamentoEquipeInterface(equipamentos, equipes));
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Erro ao adicionar botões: " + e.getMessage());
        }
    }
    ...
    private boolean alocarAtendimentos() {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao alocar atendimentos: " + e.getMessage());
            return false;
        }
    }
    ...
    private void alocarAtendimentosAux() {
        try {
            ...
            e.printStackTrace();
            textArea.setText("Erro ao alocar atendimentos auxiliares: " + e.getMessage());
        }
    }
